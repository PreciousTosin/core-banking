...
## Provisional migration decision destinations

These anchors keep source classification explicit until Task 5 creates and
links the corresponding ADR records. They are governance locations, not
completed decision extraction.

<a id="migration-provisional-accounting-invariant-boundary"></a>
<!-- migration-source: 01::02 -->
<!-- migration-source: 04.02 -->
<!-- migration-source: 05 -->
Accounting invariant ownership and authority.

<a id="migration-provisional-additive-corrections"></a>
<!-- migration-source: 04.04 -->
Additive correction and reversal semantics.

<a id="migration-provisional-idempotent-delivery"></a>
<!-- migration-source: 04.03 -->
Idempotency and at-least-once delivery semantics.

<a id="migration-provisional-signed-money-semantics"></a>
<!-- migration-source: 04.07 -->
<!-- migration-source: 08.12 -->
Signed exact-money and bank-perspective accounting semantics.

<a id="migration-provisional-postgresql-consistency-boundary"></a>
<!-- migration-source: 08.09::02 -->
PostgreSQL consistency and accounting-governance boundary.

<a id="migration-provisional-account-identifier-boundary"></a>
<!-- migration-source: 08.01.01::01 -->
Account identity and external-address separation.

<a id="migration-provisional-resource-envelope"></a>
<!-- migration-source: 04.08 -->
<!-- migration-source: 21.01 -->
Single-VM resource envelope and evidence profiles.
