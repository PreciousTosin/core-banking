 ...
 * at an account that is not OPEN, wrong book, inactive chart or stale policy, or using
 * reversal metadata on the wrong path. Deterministic for the same content; the transaction
 * has rolled back.
 */
